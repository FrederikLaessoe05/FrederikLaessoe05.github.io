...
const birdImage = new Image(90, 90);
      birdImage.src = "../assets/images/suiiii.png";
...
// score variables
const scoreImage = new Image(120, 120);
      scoreImage.src = "../assets/images/goal.png";
...
//highscore 
const highscoreimage = new Image(100, 100);
      highscoreimage.src = "../assets/images/png_golden_cup_28634.png";
const highscoreXposition = 1300;
const highscoreYposition = 80;
const highscoreTextXPosition = 1350;
const highscoreTextYPosition = 100
const highscoretextsize = 50;
const highscoretextcolor = "yellow"
...
const fireballImage = new Image(350, 350);
      fireballImage.src = "../assets/images/pepe.png";
...
const coinImage = new Image(60, 60);
coinImage.src = "../assets/images/ball.png";
